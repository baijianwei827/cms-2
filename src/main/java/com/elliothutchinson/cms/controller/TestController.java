...
public class TestController {
	...
	@RequestMapping
	public String initializeData(String name, Model model) {
	...
	public String deleteData(String name, Model model) {
	...
	public String createData(String name, Model model) {
	...
	@RequestMapping("/tags")
	public String addTags(String name, Model model) {
		testService.addTags();
