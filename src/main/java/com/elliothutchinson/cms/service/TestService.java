...
public class TestService {
    ...
    public TestService(TagRepository tagRepository, ArticleRepository articleRepository,
            SectionRepository sectionRepository, AuthorRepository authorRepository, FileRepository fileRepository,
            CommentRepository commentRepository, FeatureRepository featureRepository,
    ...
    public void createSampleData() {
        ...
        Author abe = authorRepository.findOneByUsername("abe");
        Author bob = authorRepository.findOneByUsername("bob");
        Author cat = authorRepository.findOneByUsername("cat");
        // author dan will be author without any articles

        Section android = sectionRepository.findOneByTitle("Android");
        Section apple = sectionRepository.findOneByTitle("Apple");
        Section microsoft = sectionRepository.findOneByTitle("Microsoft");
        Section nintendo = sectionRepository.findOneByTitle("Nintendo");
        ...
        Article microsoftArticle2 = articleRepository.findByTitle("Windows 10 Will Automatically Install on iPhones")
                .get(0);
        Article microsoftArticle3 = articleRepository.findByTitle("Xbox One Update").get(0);

        fileRepository.save(new File("android.jpg", androidArticle1));
        fileRepository.save(new File("apple.jpg", appleArticle1));
        fileRepository.save(new File("ipad.jpg", appleArticle1));
        fileRepository.save(new File("iphone.jpg", appleArticle1));
        ...
        commentRepository.save(new Comment(null, null, false,
                "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos.",
                appleArticle1));
        commentRepository.save(new Comment("bob", "a@t.com", true,
                "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos.",
                appleArticle1));
    ...
    public void addTags() {
        ...
        /*
         * // same as below microsoftArticle1.addTag(gameDesign);
